...
class EventAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->success($events->toArray(), 'Events retrieved successfully');
    }
    ...
    public function store(CreateEventAPIRequest $request)
    {
        ...
        return response()->success($event->toArray(), 'Event saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return response()->success($event->toArray(), 'Event retrieved successfully');
    }
    ...
    public function update($id, UpdateEventAPIRequest $request)
    {
        ...
        return response()->success($event->toArray(), 'Event updated successfully');
    }
