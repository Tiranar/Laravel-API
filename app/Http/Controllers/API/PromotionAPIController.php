...
class PromotionAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->success($promotions->toArray(), 'Promotions retrieved successfully');
    }
    ...
    public function store(CreatePromotionAPIRequest $request)
    {
        ...
        return response()->success($promotion->toArray(), 'Promotion saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return response()->success($promotion->toArray(), 'Promotion retrieved successfully');
    }
    ...
    public function update($id, UpdatePromotionAPIRequest $request)
    {
        ...
        return response()->success($promotion->toArray(), 'Promotion updated successfully');
    }
