...
class DeviceAPIController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return response()->success($devices->toArray(), 'Devices retrieved successfully');
    }
    ...
    public function store(CreateDeviceAPIRequest $request)
    {
        ...
        return response()->success($device->toArray(), 'Device saved successfully');
    }
    ...
    public function show($id)
    {
        ...
        return response()->success($device->toArray(), 'Device retrieved successfully');
    }
    ...
    public function update($id, UpdateDeviceAPIRequest $request)
    {
        ...
        return response()->success($device->toArray(), 'Device updated successfully');
    }
